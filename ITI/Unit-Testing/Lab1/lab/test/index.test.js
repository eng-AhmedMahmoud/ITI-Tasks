...
describe("capitalizeText", () => {
    ...
    it("should return a string", () => {
        expect(typeof capitalizeText("ahmed")).to.be.an("string");

        assert.typeOf(capitalizeText("ahmed"), "string");

        capitalizeText("ahmed").should.be.a("string");
    });
    //? test that the function takes a string and return it after capitalize it
    it("should return a string after capitalize it", () => {
        expect(capitalizeText("ahmed")).to.be.equal("AHMED");

        assert.equal(capitalizeText("ahmed"), "AHMED");

        capitalizeText("ahmed").should.be.equal("AHMED");
    });
